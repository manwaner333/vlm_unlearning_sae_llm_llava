...
def evaluate_classification(classification_task, image, model, id):
...
def evaluate_generation(generation_task, image, model, id):
...
def evaluate_fill_blank(mask_task, image, model, id):
...
for index in range(len(forget_dataset)):  # [0,1,2]:  # range(0, 50):
    ...
    ### classification_task
    # classification_image_textual_correct, classification_image_textual_questions, classification_pure_text_correct, classification_pure_text_questions = evaluate_classification(Classification_Task, image, model, id)
